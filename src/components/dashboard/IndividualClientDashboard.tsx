          ...
          {hasInstitutionalNna && (
            <div className="w-full xl:max-w-6xl 2xl:max-w-[1280px] mt-16 md:mt-20 xl:mt-24">
              ...
              {monitoredStudents.length === 0 ? (
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6 md:gap-8 xl:gap-10 justify-items-center">
  ...
  return (
    ...
    >
      <div className="relative">
        <div className="w-24 h-24 sm:w-28 sm:h-28 md:w-64 md:h-64 rounded-full bg-white border-4 border-white/70 flex items-center justify-center group-hover:border-white group-hover:scale-105 group-hover:shadow-2xl transition-all duration-200 overflow-hidden shadow-lg">
